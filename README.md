...
1. The user uploads the product list in the **info3/info4** structure, generated by the company management — one file for **PLI**,
...
| Fiscal code                    | Codice fiscale (COD.FISC / CF)                |
| Tax code                       | Codice di imposta / Codice del soggetto obbligato |
